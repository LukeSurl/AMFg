...
set DIR = "/group_workspaces/jasmin/geoschem/SatelliteData/OMI_HCHO_NASA_ASCII"
set Output = "/group_workspaces/jasmin/geoschem/local_users/lsurl/sat_pp/amf581n/output"
...
set prefix = '/group_workspaces/jasmin/geoschem/local_users/lsurl/runs/geosfp_025x03125_tropchem_in/ts_satellite.'

#set tropfile = '/data3/akhila/Code/GEOS-Chem.v8-02-02.stdrun/run.v8-02-02/trophghts.20050101.bpch'
set tropfile = '/group_workspaces/jasmin/geoschem/local_users/lsurl/runs/geosfp_025x03125_tropchem_in/tp-lev-in'
...
#skip if an extra file
if ( "`echo $file | cut -d'.' -f2`" == "extra" )  then
  echo $file is a .extra file
  continue
else
  echo $file is not a zip file
endif
...
set filetag = $Output"/"$filetag".hcho"
